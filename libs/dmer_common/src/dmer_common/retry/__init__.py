...
Convenience factories :func:`di_retry`/:func:`di_breaker` and
:func:`openai_retry`/:func:`openai_breaker` capture the tuned policies used by
the di-processor design (Requirements 4.5, 6.6).
"""
